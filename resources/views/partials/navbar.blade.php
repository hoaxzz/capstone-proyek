  ...
  <nav>
    <div class="navbar">
      ...
      <div class="logo"><a href="/">Sejahtera Online</a></div>
      <div class="nav-links">
        <div class="sidebar-logo">
          <span class="logo-name">Sejahtera Online</span>
          <i class='bx bx-x' ></i>
        </div>
        <ul class="links">
          <li>
            ...
            <ul class="htmlCss-sub-menu sub-menu">
              <li><a href="/pageLansia">TES KESEHATAN LANSIA</a></li>
              <li><a href="/pageMental">TES KESEHATAN MENTAL</a></li>
              <li><a href="/pageBMI">TES BMI</a></li>
            </ul>
          </li>
