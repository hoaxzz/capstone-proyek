      ...
      <div class="row m-2">
        ...
        <div class="card my-2 mx-3" style="width: 18rem;">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Andika Syahrul Firdan adalah mahasiswa dari Universitas Dirgantara Marsekal Suryadarma saat ini sedang mengerjakan Capstone Project MSIB X Dicoding Batch 4 sebagai <strong>UI/UX DESIGNER</strong></p>
